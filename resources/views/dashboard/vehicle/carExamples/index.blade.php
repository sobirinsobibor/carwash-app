      ...
      <div class="card">
        <div class="card-body">
          <div class="d-sm-flex align-items-center mb-4">
            <h4 class="card-title mb-sm-0">Car Examples</h4>
            <a href="/dashboard/carexamples/create" class="btn btn-primary ml-auto mb-3 mb-sm-0"> New Example</a>
          </div>
          <div class="row mb-3">
            <div class="col-md-6">
              <form class="d-flex" action="/dashboard/carexamples"> 
          ...
          <div class="table-responsive border rounded p-1">
            <table class="table">
              ...
              <tbody>
                ...
                @foreach ($cars->where('carCategory_id',$carCategory->id) as $car)
                <tr>
